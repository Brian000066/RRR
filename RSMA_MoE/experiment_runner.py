...
def common_scheduler_kwargs(config: ExperimentConfig, seeds: RunSeeds) -> dict[str, Any]:
    return {
        ...
        "connected_servers_per_device": config.connected_servers_per_device,
        "experts_per_server": config.experts_per_server,
        "server_gpu_memory": config.server_gpu_memory,
        "default_wired_rate": config.default_wired_rate,
        "wired_rate_range": config.wired_rate_range,
        "c_bw": config.c_bw,
        "c_act": config.c_act,
        "c_fwd": config.c_fwd,
        "uplink_time_budget": config.uplink_time_budget_seconds,
        ...
        "beamforming_correlation_weight": config.beamforming_correlation_weight,
